...
def write_top_file(output_path, ff, res_names=None, res_ids=None):
    ...
    with open(output_path, 'w', buffering=65536) as f:
        f.write(";---------------------------------------------\n")
        f.write(";           Generated with DoMD-FF\n")
        f.write(";             DoMD-Toolkit Group\n")
        f.write(";            https://www.domd.today\n")
        f.write(";             OPLS Force Field\n")
        f.write(";---------------------------------------------\n\n")
        f.write("[ defaults ]\n")
...
def write_atomtypes_head(output_path, unique_atomtypes, write_defaults=False):
    ...
    with open(output_path, 'w', buffering=65536) as f:
        if write_defaults:
            f.write("; ==================================================================\n")
            f.write("; Main topology file generated by DoMD-FF\n")
            f.write("; ==================================================================\n\n")
