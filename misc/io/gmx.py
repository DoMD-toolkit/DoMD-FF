...
def write_itp_file(output_path, ff, res_names, res_ids, mol_name="MOL", unique_atomtypes=None, atomidx2atomtype=None,
...
def write_list_itp_files(output_path, forcefields, molecule_name):
    '''
    :: params
    ...
    for out_p, ff, mol_n in zip(output_path, forcefields, molecule_name):
        params_atom, _, _ = ff.params
    ...
    # ---------------------------------------------------------
    # Step 4: 统一收尾，在第一个 ITP 文件同级目录下导出全局 atomtypes.itp
    # ---------------------------------------------------------
    if output_path:
